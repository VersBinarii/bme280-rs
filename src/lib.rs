    ...
    I2C: Read<Error = E> + Write<Error = E> + WriteRead<Error = E>,
{
    ...
    fn soft_reset<D>(&mut self, delay: &mut D) -> Result<(), Error<E>>
    where
        D: DelayMs<u8>,
    {
    ...
    fn configure<D>(&mut self, delay: &mut D) -> Result<(), Error<E>>
    where
        D: DelayMs<u8>,
    {
        match self.mode()? {
    ...
    fn forced<D>(&mut self, delay: &mut D) -> Result<(), Error<E>>
    where
        D: DelayMs<u8>,
    {
    ...
    fn set_mode<D>(&mut self, mode: u8, delay: &mut D) -> Result<(), Error<E>>
    where
        D: DelayMs<u8>,
    {
        match self.mode()? {
    ...
    pub fn measure<D>(&mut self, delay: &mut D) -> Result<Measurements<E>, Error<E>>
    where
        D: DelayMs<u8>,
    {
        self.forced(delay)?;
